            ...
            <div className="global-container">
                <div className="header">
                    ...
                    <p className="paragraph">
                        Reinvent business models or monetize financial services
                        on your platform.
                    </p>
                </div>
                            ...
                            <div className="revenue-item">
                                <div className="about-revenue">
                                    <div className="subheading">
                                        ...
                                        payments volume by 10%
                                    </div>

                                    <div className="paragraph">
                                        Embed payments into your platform with
                                        user onboarding, multiparty fund flows,
                                        payouts, managed risk and support, and
                                        monetization.
                                    </div>
                        ...
                        <div className="revenue-types">
                            <div className="revenue-item">
                                <div className="about-revenue">
                                    ...
                                    <div className="paragraph">
                                        Use Stripe's banking-as-a-service
                                        solutions to diversify revenue streams
                                        by offering your users access to card
                                        issuing, financial accounts, and
                                        business financing.
                                    </div>

                                    <div className="tags">
                                        <div className="tag-wrapper">
                                            <p className="link">Issuing</p>
                                        </div>
                                        <div className="tag-wrapper">
                                            <p className="link">Financing</p>
                                        </div>
                                        <div className="tag-wrapper">
                                            <p className="link">Treasury</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="all-sponsor">
                        ...
                        <div className="sponsor">
                            ...
                            <div className="desc">
                                ...
                                <div className="fame">
                                    BMW partnered with Stripe to offer owners a
                                    secure and seamless payments experience
                                    across all channels
                                </div>
                                <p className="link">Learn More</p>
                            </div>
